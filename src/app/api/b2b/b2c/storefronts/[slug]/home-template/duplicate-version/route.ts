...
import { duplicateB2CHomeTemplateVersion } from "@/lib/db/b2c-home-templates";

type RouteParams = { params: Promise<{ slug: string }> };

/**
 * POST /api/b2b/b2c/storefronts/[slug]/home-template/duplicate-version
 */
export async function POST(req: NextRequest, { params }: RouteParams) {
  try {
    ...
    const config = await duplicateB2CHomeTemplateVersion(slug, version, auth.tenantDb!);
