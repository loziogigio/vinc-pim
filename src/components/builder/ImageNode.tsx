    ...
    <NodeViewWrapper className="relative my-4">
      <div className="flex flex-col gap-2">
        ...
        <div className={`relative inline-block ${alignmentClass}`}>
          ...
          {showControls && (
            <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-white border border-slate-300 rounded-lg shadow-lg p-1 flex items-center gap-1 z-10">
              {/* Size buttons */}
              <button
                onClick={() => setSize("small")}
                className="px-3 py-1 text-xs font-medium rounded hover:bg-slate-100 transition"
                title="Small (300px)"
              >
                Small
              </button>
              ...
              <button
                ...
                className={`p-1.5 rounded hover:bg-slate-100 transition ${
                  node.attrs.align === "left" ? "bg-slate-200" : ""
                }`}
                title="Align left"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded hover:bg-slate-100 transition ${
                  node.attrs.align === "center" || !node.attrs.align ? "bg-slate-200" : ""
                }`}
                title="Align center"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded hover:bg-slate-100 transition ${
                  node.attrs.align === "right" ? "bg-slate-200" : ""
                }`}
                title="Align right"
              >
