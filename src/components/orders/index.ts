 ...
 *
 * Components for order lifecycle management:
 * - StatusActionsCard: Status display with transition buttons
 * - QuotationCard: Quotation details and actions
 * - PaymentCard: Payment tracking and recording
