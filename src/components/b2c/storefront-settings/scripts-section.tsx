  ...
  return (
    <div className="rounded-xl border border-border bg-muted/50 overflow-hidden">
      ...
      <div className="flex items-center gap-2 px-4 py-3">
        ...
        {/* Enabled toggle */}
        <label className="flex items-center gap-1.5 text-xs text-muted-foreground cursor-pointer whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
          <input
            type="checkbox"
        ...
        <button
          ...
          className="rounded-lg p-1.5 text-muted-foreground hover:bg-red-50 dark:hover:bg-red-950/30 hover:text-red-500 dark:hover:text-red-400 transition-colors"
          title="Remove script"
        >
        ...
        <div className="border-t border-border px-4 py-4 space-y-4">
          ...
          {showPaste ? (
            <div className="space-y-2">
              <label className="text-xs font-medium text-foreground">Paste your script snippet</label>
              <textarea
                value={pasteValue}
            ...
            <>
              ...
              <div className="space-y-3">
                {/* External URL */}
                <div className="space-y-1">
                  <label className="text-xs font-medium text-foreground">External URL</label>
                  <input
                    type="url"
                    value={script.src || ""}
                ...
                {/* Inline Code */}
                <div className="space-y-1">
                  <label className="text-xs font-medium text-foreground">Inline Code</label>
                  <textarea
                    ...
                    className={`${inputClass} font-mono text-xs`}
                  />
                  <p className="text-xs text-muted-foreground">JavaScript code without &lt;script&gt; tags</p>
                </div>
          ...
          {showAdvanced && (
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                <label className="text-xs font-medium text-foreground">Placement</label>
                <select
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium text-foreground">Loading Strategy</label>
                <select
