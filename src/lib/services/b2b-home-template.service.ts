 ...
 * Load a specific version as the "current" working version for a portal.
 *
 * Re-exported here for API route import convenience — the same function
 * already exists above and is the canonical implementation.
 *
 * Note: This is already declared above as loadHomeTemplateVersion — the
 * route for load-version calls loadHomeTemplateVersion directly.
 */
