...
/** Ordinal rank for comparing access levels (none < view < edit). */
export function priceAccessRank(value: PriceAccess): number {
  return PRICE_ACCESS_LEVELS.indexOf(value);
}
