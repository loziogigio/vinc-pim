...
export type ContentBlockConfig = ContentRichTextConfig | ContentFeaturesConfig | ContentTestimonialsConfig | ContentCustomHtmlConfig;
...
export type BlockConfig = HeroBlockConfig | ProductBlockConfig | CategoryBlockConfig | ContentBlockConfig | MediaBlockConfig | HeroCarouselBlockConfig | MediaCarouselBlockConfig | ProductDataTableBlockConfig | FormBlockConfig;
...
export interface BlockFamily<TVariants extends Record<string, BlockVariantDefinition<BlockConfig>>> {
    id: string;
    name: string;
...
export type BlockRegistry = {
    hero: BlockFamily<{
        fullWidth: BlockVariantDefinition<Extract<HeroBlockConfig, {
            variant: "fullWidth";
        }>>;
        split: BlockVariantDefinition<Extract<HeroBlockConfig, {
            variant: "split";
        }>>;
        carousel: BlockVariantDefinition<Extract<HeroBlockConfig, {
            variant: "carousel";
        }>>;
    }>;
    product: BlockFamily<{
        slider: BlockVariantDefinition<Extract<ProductBlockConfig, {
            variant: "slider";
        }>>;
        grid: BlockVariantDefinition<Extract<ProductBlockConfig, {
            variant: "grid";
        }>>;
    }>;
    category: BlockFamily<{
        grid: BlockVariantDefinition<Extract<CategoryBlockConfig, {
            variant: "grid";
        }>>;
        carousel: BlockVariantDefinition<Extract<CategoryBlockConfig, {
            variant: "carousel";
        }>>;
    }>;
    content: BlockFamily<{
        richText: BlockVariantDefinition<Extract<ContentBlockConfig, {
            variant: "richText";
        }>>;
        features: BlockVariantDefinition<Extract<ContentBlockConfig, {
            variant: "features";
        }>>;
        testimonials: BlockVariantDefinition<Extract<ContentBlockConfig, {
            variant: "testimonials";
        }>>;
        customHtml: BlockVariantDefinition<Extract<ContentBlockConfig, {
            variant: "customHtml";
        }>>;
    }>;
    media: BlockFamily<{
