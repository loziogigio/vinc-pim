...
const Label = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)(LabelPrimitive.Root, { ref: ref, className: (0, utils_js_1.cn)(labelVariants(), className), ...props })));
exports.Label = Label;
