...
const contentRichTextDefault = {
    variant: "richText",
    content: "<p class='leading-relaxed'>Add engaging content, FAQs, or installation tips to support your trade customers.</p>",
    width: "contained",
    textAlign: "left",
    padding: "medium"
};
const contentFeaturesDefault = {
    variant: "features",
...
const contentTestimonialsDefault = {
...
const contentCustomHtmlDefault = {
    variant: "customHtml",
    html: "<section>\n  <!-- Custom HTML block -->\n</section>"
};
const productDataTableDefault = {
    variant: "productDataTable",
    title: "Documenti e Specifiche",
    description: "Mostra documenti lato sinistro e la descrizione/azioni sulla destra. Ogni riga può avere un'icona immagine e un link.",
...
const getAllBlockTemplates = () => Object.values(exports.BLOCK_REGISTRY).flatMap((section) => Object.values(section.variants));
exports.getAllBlockTemplates = getAllBlockTemplates;
const getBlockTemplate = (variantId) => {
    for (const section of Object.values(exports.BLOCK_REGISTRY)) {
...
const resolveDefaultBlocks = () => exports.DEFAULT_HOME_BLOCKS.map((block, index) => ({
    ...block,
    order: typeof block.order === "number" ? block.order : index,
}));
exports.resolveDefaultBlocks = resolveDefaultBlocks;
/** Block variants available in the custom-page builder. */
exports.PAGE_BLOCKS = [
    "hero-full-width", "hero-split", "hero-with-widgets", "carousel-hero",
    "carousel-products", "carousel-gallery", "content-rich-text",
    "content-custom-html", "youtubeEmbed", "media-image", "form-contact",
];
